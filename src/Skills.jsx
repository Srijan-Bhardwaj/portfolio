...
const Skill = () => {
    const [HWidth,SetHWidth] = useState(1);
    const [CWidth,SetCWidth] = useState(1);
    const [RWidth,SetRWidth] = useState(1);
  ...
  return (
    <>
      <div className="card_container" >
        <div className="card_wrapper" id="skills">
          <div className="card_heading">skills</div>
          <div className="svg_container" data-aos="zoom-in-up" data-aos-once="true">
            <div className="react" data-aos="zoom-in-up" data-aos-once="true" data-aos-delay="250">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/1280px-React-icon.svg.png" alt="React JS"/>
            </div>
            <div className="html" data-aos="zoom-in-up" data-aos-once="true" data-aos-delay="250">
                <img src="https://cdn.iconscout.com/icon/free/png-256/html5-10-569380.png" alt="html"/>
            </div>
            <div className="css" data-aos="zoom-in-up" data-aos-once="true" data-aos-delay="250">
              <img src="https://cdn.iconscout.com/icon/free/png-256/css3-9-1175237.png" alt="css"/>
            </div>
            <div className="java" data-aos="zoom-in-up" data-aos-once="true" data-aos-delay="250">
              <img src="https://pics.freeicons.io/uploads/icons/png/378554371540553613-512.png" alt="java"/>
            </div>
            <div className="python"></div>
            <div className="cpp" data-aos="zoom-in-up" data-aos-once="true" data-aos-delay="250">
              <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/ISO_C%2B%2B_Logo.svg/306px-ISO_C%2B%2B_Logo.svg.png" alt="CPP"/>
            </div>
            <div className="sql" data-aos="zoom-in-up" data-aos-once="true" data-aos-delay="250">
              <img src="https://download.logo.wine/logo/MySQL/MySQL-Logo.wine.png" alt="MySQL"/>
            </div>
            <div className="python" data-aos="zoom-in-up" data-aos-once="true" data-aos-delay="250">
              <img src="https://lh3.googleusercontent.com/proxy/FJFCNuPwFnq7kdHU7UDaLQIsyp0HPNg_c6HhsteqY1DmRylgn0EKyqnWfiKobxJ2zIXakQsis7_ejfKt_Y9Gjd3YjzlHwussY0qmvol_T_IBzG3YKMcPm1HDTtbO_Ih9FAk12RA" alt="python"/>
            </div>
            <svg
